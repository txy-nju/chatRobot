...
Web-based administration interface. Provides a graphical UI for managing skills (with dual form/Markdown editing), configuring LLM providers, adjusting bot behavior, connecting messaging platforms, and testing conversations in real time.
